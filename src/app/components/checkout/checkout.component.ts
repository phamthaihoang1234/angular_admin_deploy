...
export class CheckoutComponent implements OnInit {
  ...
  checkOut() {
    ...
    console.log("ten ghi la la:"+ this.postForm.value.name);
    console.log("so dien thoai la:"+ this.ward.name);
    console.log("so dien thoai la:"+ this.district.name);
    console.log("so dien thoai la:"+ this.province.name);
    console.log("so dien thoai la:"+ this.postForm.value.number);
    if(email != null){
